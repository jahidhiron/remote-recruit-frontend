      ...
      <div className="bg-white rounded-2xl shadow-2xl shadow-brand-100/80 overflow-hidden border border-gray-100">
        ...
        <div className="px-5 pt-5 pb-4 border-b border-gray-100">
          <div className="flex items-center justify-between mb-1">
            <span className="text-xs text-gray-600 font-medium">Your Membership Plan</span>
          ...
          <div className="text-brand-700 font-extrabold text-xl">Premium</div>
        </div>
          ...
          {premiumFeatures.map((f) => (
            <div key={f} className="flex items-center gap-2.5">
              <div className="w-4 h-4 rounded-full bg-brand-100 flex items-center justify-center shrink-0">
                <Check size={9} className="text-brand-700" strokeWidth={3} aria-hidden="true" />
              </div>
        ...
        <div className="px-5 py-3 bg-gray-50 border-t border-gray-100">
          <div className="text-xs text-gray-600 mb-0.5">Upcoming Payment In...</div>
          <div className="flex items-center justify-between">
            <span className="text-xs font-semibold text-gray-700">14 Days</span>
            <span className="text-xs font-bold text-brand-700">$79.95</span>
          </div>
        </div>
      </div>
    </div>
...
export function FeatureSectionFeesFree() {
  ...
  return (
    <section aria-labelledby="fees-heading" className="py-20 bg-gray-50/60 overflow-hidden" ref={ref}>
      <div className="max-w-7xl mx-auto px-6 lg:px-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          {/* Left – Mockup (decorative) */}
          <div
            className={cn(
          ...
          >
            ...
            <h2 id="fees-heading" className="text-3xl sm:text-4xl font-extrabold text-gray-900 leading-tight mb-5">
              Fee-Free Forever
            </h2>
